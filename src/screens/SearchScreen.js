...
import { SafeAreaView, StyleSheet, Pressable, Text, TouchableOpacity, View, FlatList} from 'react-native';
    ...
    const renderItem = ({item}) => {
        return (
            ...
            style = {styles.itemCard}>
                ...
                variant="titleLarge">{item.title}</Text>
                </Card.Content>
            </Card>
        );
    };
